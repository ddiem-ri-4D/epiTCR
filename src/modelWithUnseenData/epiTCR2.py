...
def main():
    ...
    if chain == 'ce':
        ...
        Model.saveByPickle(model_rf, "./models/rdforestWithoutMHCNonOverlappingModel.pickle")
        ...
        Model.saveByPickle(model_rf_mhc, "./models/rdforestWithMHCNonOverlappingModel.pickle")
