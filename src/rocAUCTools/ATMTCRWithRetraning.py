...
test01_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test01_pred.csv")
test02_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test02_pred.csv")
test03_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test03_pred.csv")
test04_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test04_pred.csv")
test05_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test05_pred.csv")
test06_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test06_pred.csv")
test07_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test07_pred.csv")
test08_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test08_pred.csv")
test09_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test09_pred.csv")
test10_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test10_pred.csv")
test11_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test11_pred.csv")
test12_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test12_pred.csv")
test13_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test13_pred.csv")
test14_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test14_pred.csv")
test15_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Retraining/test15_pred.csv")
...
df.to_csv("../../data/outputPerformance/ATMTCR/Retraining/outputPerformance.csv", index=False)
...
def draw_ROC_Curve(y_trues, y_preds, cutoffs):
    ...
    plt.savefig("../../analysis/figures/benchmarkATMTCRRetraining.png", dpi=600)
    plt.savefig("../../analysis/figures/benchmarkATMTCRRetraining.pdf", dpi=600)
