...
test01_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test01_pred.csv")
test02_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test02_pred.csv")
test03_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test03_pred.csv")
test04_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test04_pred.csv")
test05_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test05_pred.csv")
test06_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test06_pred.csv")
test07_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test07_pred.csv")
test08_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test08_pred.csv")
test09_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test09_pred.csv")
test10_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test10_pred.csv")
test11_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test11_pred.csv")
test12_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test12_pred.csv")
test13_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test13_pred.csv")
test14_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test14_pred.csv")
test15_pred = pd.read_csv("../../data/predToolsData/NetTCR/Retraining/test15_pred.csv")
