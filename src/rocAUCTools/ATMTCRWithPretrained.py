...
test01_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test01_pred.csv")
test02_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test02_pred.csv")
test03_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test03_pred.csv")
test04_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test04_pred.csv")
test05_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test05_pred.csv")
test06_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test06_pred.csv")
test07_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test07_pred.csv")
test08_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test08_pred.csv")
test09_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test09_pred.csv")
test10_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test10_pred.csv")
test11_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test11_pred.csv")
test12_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test12_pred.csv")
test13_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test13_pred.csv")
test14_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test14_pred.csv")
test15_pred = pd.read_csv("../../data/predToolsData/ATMTCR/Pretrained/test15_pred.csv")
...
auc01 = metrics.roc_auc_score(y_test01, test01_pred["predict_proba"])
auc02 = metrics.roc_auc_score(y_test02, test02_pred["predict_proba"])
auc03 = metrics.roc_auc_score(y_test03, test03_pred["predict_proba"])
auc04 = metrics.roc_auc_score(y_test04, test04_pred["predict_proba"])
auc05 = metrics.roc_auc_score(y_test05, test05_pred["predict_proba"])
auc06 = metrics.roc_auc_score(y_test06, test06_pred["predict_proba"])
auc07 = metrics.roc_auc_score(y_test07, test07_pred["predict_proba"])
auc08 = metrics.roc_auc_score(y_test08, test08_pred["predict_proba"])
auc09 = metrics.roc_auc_score(y_test09, test09_pred["predict_proba"])
auc10 = metrics.roc_auc_score(y_test10, test10_pred["predict_proba"])
auc11 = metrics.roc_auc_score(y_test11, test11_pred["predict_proba"])
auc12 = metrics.roc_auc_score(y_test12, test12_pred["predict_proba"])
auc13 = metrics.roc_auc_score(y_test13, test13_pred["predict_proba"])
auc14 = metrics.roc_auc_score(y_test14, test14_pred["predict_proba"])
auc15 = metrics.roc_auc_score(y_test15, test15_pred["predict_proba"])
...
df.to_csv("../../data/outputPerformance/ATMTCR/Pretrained/outputPerformance.csv", index=False)

prob01 = test01_pred["predict_proba"]
prob02 = test02_pred["predict_proba"]
prob03 = test03_pred["predict_proba"]
prob04 = test04_pred["predict_proba"]
prob05 = test05_pred["predict_proba"]
prob06 = test06_pred["predict_proba"]
prob07 = test07_pred["predict_proba"]
prob08 = test08_pred["predict_proba"]
prob09 = test09_pred["predict_proba"]
prob10 = test10_pred["predict_proba"]
prob11 = test11_pred["predict_proba"]
prob12 = test12_pred["predict_proba"]
prob13 = test13_pred["predict_proba"]
prob14 = test14_pred["predict_proba"]
prob15 = test15_pred["predict_proba"]
...
def draw_ROC_Curve(y_trues, y_preds, cutoffs):
    ...
    ax.plot(fpr01, tpr01, label = 'ATM-TCR - test01 (AUC = {0})'.format(round(auc01,3)),linewidth=2)
    ax.plot(fpr02, tpr02, label = 'ATM-TCR - test02 (AUC = {0})'.format(round(auc02,3)),linewidth=2)
    ax.plot(fpr03, tpr03, label = 'ATM-TCR - test03 (AUC = {0})'.format(round(auc03,3)),linewidth=2)
    ax.plot(fpr04, tpr04, label = 'ATM-TCR - test04 (AUC = {0})'.format(round(auc04,3)),linewidth=2)
    ax.plot(fpr05, tpr05, label = 'ATM-TCR - test05 (AUC = {0})'.format(round(auc05,3)),linewidth=2)
    ax.plot(fpr06, tpr06, label = 'ATM-TCR - test06 (AUC = {0})'.format(round(auc06,3)),linewidth=2)
    ax.plot(fpr07, tpr07, label = 'ATM-TCR - test07 (AUC = {0})'.format(round(auc07,3)),linewidth=2)
    ax.plot(fpr08, tpr08, label = 'ATM-TCR - test08 (AUC = {0})'.format(round(auc08,3)),linewidth=2)
    ax.plot(fpr09, tpr09, label = 'ATM-TCR - test09 (AUC = {0})'.format(round(auc09,3)),linewidth=2)
    ax.plot(fpr10, tpr10, label = 'ATM-TCR - test10 (AUC = {0})'.format(round(auc10,3)),linewidth=2)
    ax.plot(fpr11, tpr11, label = 'ATM-TCR - test11 (AUC = {0})'.format(round(auc11,3)),linewidth=2)
    ax.plot(fpr12, tpr12, label = 'ATM-TCR - test12 (AUC = {0})'.format(round(auc12,3)),linewidth=2)
    ax.plot(fpr13, tpr13, label = 'ATM-TCR - test13 (AUC = {0})'.format(round(auc13,3)),linewidth=2)
    ax.plot(fpr14, tpr14, label = 'ATM-TCR - test14 (AUC = {0})'.format(round(auc14,3)),linewidth=2)
    ax.plot(fpr15, tpr15, label = 'ATM-TCR - test15 (AUC = {0})'.format(round(auc15,3)),linewidth=2)    
    ...
    plt.savefig("../../analysis/figures/benchmarkATMTCRPretrained.png", dpi=600)
    plt.savefig("../../analysis/figures/benchmarkATMTCRPretrained.pdf", dpi=600)
