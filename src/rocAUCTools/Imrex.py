...
test01_pred = pd.read_csv("../../data/predToolsData/Imrex/test01_pred.csv")
test02_pred = pd.read_csv("../../data/predToolsData/Imrex/test02_pred.csv")
test03_pred = pd.read_csv("../../data/predToolsData/Imrex/test03_pred.csv")
test04_pred = pd.read_csv("../../data/predToolsData/Imrex/test04_pred.csv")
test05_pred = pd.read_csv("../../data/predToolsData/Imrex/test05_pred.csv")
test06_pred = pd.read_csv("../../data/predToolsData/Imrex/test06_pred.csv")
test07_pred = pd.read_csv("../../data/predToolsData/Imrex/test07_pred.csv")
test08_pred = pd.read_csv("../../data/predToolsData/Imrex/test08_pred.csv")
test09_pred = pd.read_csv("../../data/predToolsData/Imrex/test09_pred.csv")
test10_pred = pd.read_csv("../../data/predToolsData/Imrex/test10_pred.csv")
test11_pred = pd.read_csv("../../data/predToolsData/Imrex/test11_pred.csv")
test12_pred = pd.read_csv("../../data/predToolsData/Imrex/test12_pred.csv")
test13_pred = pd.read_csv("../../data/predToolsData/Imrex/test13_pred.csv")
test14_pred = pd.read_csv("../../data/predToolsData/Imrex/test14_pred.csv")
test15_pred = pd.read_csv("../../data/predToolsData/Imrex/test15_pred.csv")
...
auc01 = metrics.roc_auc_score(y_test01, test01_pred["prediction_score"])
auc02 = metrics.roc_auc_score(y_test02, test02_pred["prediction_score"])
auc03 = metrics.roc_auc_score(y_test03, test03_pred["prediction_score"])
auc04 = metrics.roc_auc_score(y_test04, test04_pred["prediction_score"])
auc05 = metrics.roc_auc_score(y_test05, test05_pred["prediction_score"])
auc06 = metrics.roc_auc_score(y_test06, test06_pred["prediction_score"])
auc07 = metrics.roc_auc_score(y_test07, test07_pred["prediction_score"])
auc08 = metrics.roc_auc_score(y_test08, test08_pred["prediction_score"])
auc09 = metrics.roc_auc_score(y_test09, test09_pred["prediction_score"])
auc10 = metrics.roc_auc_score(y_test10, test10_pred["prediction_score"])
auc11 = metrics.roc_auc_score(y_test11, test11_pred["prediction_score"])
auc12 = metrics.roc_auc_score(y_test12, test12_pred["prediction_score"])
auc13 = metrics.roc_auc_score(y_test13, test13_pred["prediction_score"])
auc14 = metrics.roc_auc_score(y_test14, test14_pred["prediction_score"])
auc15 = metrics.roc_auc_score(y_test15, test15_pred["prediction_score"])
...
df.to_csv("../../data/outputPerformance/Imrex/outputPerformance.csv", index=False)

prob01 = test01_pred["prediction_score"]
prob02 = test02_pred["prediction_score"]
prob03 = test03_pred["prediction_score"]
prob04 = test04_pred["prediction_score"]
prob05 = test05_pred["prediction_score"]
prob06 = test06_pred["prediction_score"]
prob07 = test07_pred["prediction_score"]
prob08 = test08_pred["prediction_score"]
prob09 = test09_pred["prediction_score"]
prob10 = test10_pred["prediction_score"]
prob11 = test11_pred["prediction_score"]
prob12 = test12_pred["prediction_score"]
prob13 = test13_pred["prediction_score"]
prob14 = test14_pred["prediction_score"]
prob15 = test15_pred["prediction_score"]
...
def draw_ROC_Curve(y_trues, y_preds, cutoffs):
    ...
    ax.plot(fpr01, tpr01, label = 'Imrex - test01 (AUC = {0})'.format(round(auc01,3)),linewidth=2)
    ax.plot(fpr02, tpr02, label = 'Imrex - test02 (AUC = {0})'.format(round(auc02,3)),linewidth=2)
    ax.plot(fpr03, tpr03, label = 'Imrex - test03 (AUC = {0})'.format(round(auc03,3)),linewidth=2)
    ax.plot(fpr04, tpr04, label = 'Imrex - test04 (AUC = {0})'.format(round(auc04,3)),linewidth=2)
    ax.plot(fpr05, tpr05, label = 'Imrex - test05 (AUC = {0})'.format(round(auc05,3)),linewidth=2)
    ax.plot(fpr06, tpr06, label = 'Imrex - test06 (AUC = {0})'.format(round(auc06,3)),linewidth=2)
    ax.plot(fpr07, tpr07, label = 'Imrex - test07 (AUC = {0})'.format(round(auc07,3)),linewidth=2)
    ax.plot(fpr08, tpr08, label = 'Imrex - test08 (AUC = {0})'.format(round(auc08,3)),linewidth=2)
    ax.plot(fpr09, tpr09, label = 'Imrex - test09 (AUC = {0})'.format(round(auc09,3)),linewidth=2)
    ax.plot(fpr10, tpr10, label = 'Imrex - test10 (AUC = {0})'.format(round(auc10,3)),linewidth=2)
    ax.plot(fpr11, tpr11, label = 'Imrex - test11 (AUC = {0})'.format(round(auc11,3)),linewidth=2)
    ax.plot(fpr12, tpr12, label = 'Imrex - test12 (AUC = {0})'.format(round(auc12,3)),linewidth=2)
    ax.plot(fpr13, tpr13, label = 'Imrex - test13 (AUC = {0})'.format(round(auc13,3)),linewidth=2)
    ax.plot(fpr14, tpr14, label = 'Imrex - test14 (AUC = {0})'.format(round(auc14,3)),linewidth=2)
    ax.plot(fpr15, tpr15, label = 'Imrex - test15 (AUC = {0})'.format(round(auc15,3)),linewidth=2)    
    ...
    plt.savefig("../../analysis/figures/benchmarkImrexPretranined.png", dpi=600)
    plt.savefig("../../analysis/figures/benchmarkImrexPretranined.pdf", dpi=600)
